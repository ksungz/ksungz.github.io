...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "해커톤이 끝난 뒤에는 LangGraph를 학습하기 위한 후속 PoC로 AI 코딩 에이전트와 함께 금융 답변 도구에 사람 검토 단계를 추가했습니다. 문제가 없는 답변은 바로 통과하고, 확인할 내용이 있으면 멈춘 뒤 사람이 승인하거나 수정하거나 반려할 수 있습니다. 현재는 워크북으로 코드와 실행 경로를 학습하고 있습니다.",
    ],
  },
  {
    label: "확인",
  ...
  },
  {
    ...
    body: [
      ...
      "해커톤 제출물을 공개하는 데서 끝내지 않고, 금융 답변 검사에 사람의 결정을 연결하는 후속 학습 PoC를 추가했습니다. 코드와 테스트용 예시는 GitHub에서 확인할 수 있으며, LangGraph는 아직 독립적으로 설계·운영한 실무 경험이 아니라 학습 중인 범위입니다.",
    ],
  },
  {
    label: "현재 한계",
