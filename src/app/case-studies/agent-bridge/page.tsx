...
const sections = [
  ...
  {
    label: "My Role",
    title: "제품 범위와 검증·공개 판단을 책임졌습니다",
    body: [
      "Agent Bridge가 인증·결제나 API 프록시를 대신하지 않는다는 경계와 작업 폴더 구조, 명령 체계, CLI 어댑터 형식과 완료 기준을 정했습니다.",
      "Codex와 Claude를 활용해 구현·테스트·문서 초안을 만들고, 명령 흐름과 결과 파일을 검토했습니다. 자동 테스트와 실제 로그인된 Codex CLI 실행으로 완료 여부를 확인하고 MIT 공개와 릴리스 범위를 결정했습니다.",
    ],
  },
  {
    label: "Decision",
