...
const sections = [
  ...
  {
    label: "My Role",
    title: "제품 범위와 운영 기준, 최종 공개를 책임졌습니다",
    body: [
      "서비스 구조와 콘텐츠 생성·검증·발행 규칙, 자동화 범위와 완료 기준을 정했습니다. AI 코딩 에이전트를 활용해 Next.js·Supabase 기반 화면과 데이터 구조, 가이드 API와 Google Apps Script 자동화를 구현한 뒤 실제 서비스와 운영 기록으로 검증했습니다.",
