...
const sections = [
  ...
  {
    label: "My Role",
    title: "제품 범위와 판정 기준, 검증·공개를 책임졌습니다",
    body: [
      "설치 패키지로 시작한 아이디어를 도입 전 점검 도구로 다시 정의하고, 제품 범위와 비목표, 입력·출력 계약, 위협 모델과 단계별 완료 기준을 먼저 작성했습니다.",
      "Codex와 Claude를 활용해 Go CLI, JSON Schema, 합성 데모와 검증 코드를 구현하고 교차 검토했습니다. 범위와 판정 기준, 테스트 통과 여부와 최종 반영·공개 범위는 실제 명령 결과를 확인한 뒤 직접 결정했습니다.",
    ],
  },
  {
    label: "Hypothesis",
